<?php
//this php tests if theres any content in the email, conent, and //subject POST variables and displayed a error if not
    $error = ""; 
	$successMessage = "";
...
//if the email input doesn't matches the email format then a //error is displayed      
	...
	//else the inputs are put into their respective POST variables
	   else {
		...
		//theres a POST for the inputs then a success message //is displayed else error
...
//this script checks if the email, subject, and econtent inputs // are empty and displays a error that corresponds to it  
